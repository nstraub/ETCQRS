...
namespace ETCQRS.Query.Tests.Extensions.QueryBuildDirectorExtensionsSpec
{
    ...
    {
        private Mock<IQueryBuildDirector> _directorMock;
        private IQueryBuildDirector _director;

        [SetUp]
        public void SetupTest ()
        {
            _directorMock = new Mock<IQueryBuildDirector>();
            _director = _directorMock.Object;
            _directorMock.SetupGet(d => d.And).Returns(_director);
            _directorMock.Setup(d => d.AddExpression(It.IsAny<Func<Expression, Expression, BinaryExpression>>(), "test")).Returns(_director);
            _directorMock.Setup(d => d.Mutate()).Returns(_director);
        }

        [Test]
        public void EQUAL_METHOD ()
        {
            QueryBuildDirectorExtensions.Equal(_director, "test");
        ...
        {
            QueryBuildDirectorExtensions.NotEqual(_director, "test");
        ...
        {
            QueryBuildDirectorExtensions.IsGreaterThan(_director, "test");
        ...
        {
            QueryBuildDirectorExtensions.IsLessThan(_director, "test");
        ...
        {
            QueryBuildDirectorExtensions.InOpenInterval(_director, "test", "test");
            _directorMock.Verify(d => d.AddExpression(Expression.GreaterThan, "test"), Times.Once);
            _directorMock.Verify(d => d.AddExpression(Expression.LessThan, "test"), Times.Once);
        }
        ...
        {
            QueryBuildDirectorExtensions.InClosedInterval(_director, "test", "test");
