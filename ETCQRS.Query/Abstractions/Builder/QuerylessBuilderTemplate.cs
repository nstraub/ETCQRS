...
namespace ETCQRS.Query.Abstractions.Builder {
    public abstract class QuerylessBuilderTemplate<T> : QueryBuilderTemplate<T> where T : class, IQuery {
        public QuerylessBuilderTemplate (IQueryDescriptorFactory descriptorFactory, IQueryExpressionBuilder expressionBuilder) : base(descriptorFactory, expressionBuilder) { }
